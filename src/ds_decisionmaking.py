...
output_dir = f"../../outputs/decisionmaking/deepseek/{axis}"
...
def save_results_to_csv(results, case, sub_case, gender):
    output_csv_path = os.path.join(output_dir, f"{axis}_{gender}_{case}{sub_case}_deepseek_responses.csv")
...
# try new end
                ...
                for case, case_results in [
                    ...
                    output_csv_path = os.path.join(output_dir, f"{axis}_{gender}_{case[0]}{case[1]}_deepseek_responses.csv")
